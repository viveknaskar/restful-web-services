...
import com.viveknaskar.restfulwebservices.beans.Post;
import com.viveknaskar.restfulwebservices.beans.User;
import com.viveknaskar.restfulwebservices.data.PostRepository;
...
public class UserJPAController {
    ...
    public List<Post> retrieveAllPosts(@PathVariable int id) {
        ...
        if(!user.isPresent()) {
            throw new UserNotFoundException("Not found for id: " + id);
        }
